...
namespace Antiban
{
    public class UnitTest1
    {
        ...
        public async void Test2()
        {
            ...
            Assert.True(result[1].QueueNumber == 2 && result[1].EventMessageId == 2
                && result[1].Priority == 1 && result[1].DateTime == date2);
            Assert.True(result[2].QueueNumber == 3 && result[2].EventMessageId == 4
                && result[2].Priority == 1 && result[2].DateTime == date4);
            Assert.True(result[3].QueueNumber == 4 && result[3].EventMessageId == 5
                && result[3].Priority == 0 && result[3].DateTime == date5);
            Assert.True(result[4].QueueNumber == 4 && result[4].EventMessageId == 6
                && result[4].Priority == 1 && result[4].DateTime == date6);
            Assert.True(result[5].QueueNumber == 5 && result[5].EventMessageId == 7
                && result[5].Priority == 0 && result[5].DateTime == date7.AddSeconds(9));
            Assert.True(result[6].QueueNumber == 6 && result[6].EventMessageId == 9
                && result[6].Priority == 0 && result[6].DateTime == date9);
            Assert.True(result[7].QueueNumber == 7 && result[7].EventMessageId == 10
                && result[7].Priority == 0 && result[7].DateTime == date10);
            Assert.True(result[8].QueueNumber == 8 && result[8].EventMessageId == 8
