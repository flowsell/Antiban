...
namespace Antiban
{
    public class AntibanTests
    {
        ...
        public void Test6()
        {
            ...
            Assert.True(results[0].EventMessageId == 1 && results[0].SentDateTime == new DateTime(year, month, day, 12, 0, 0));
            Assert.True(results[1].EventMessageId == 2 && results[1].SentDateTime == new DateTime(year, month, day, 12, 1, 0));
            Assert.True(results[2].EventMessageId == 3 && results[2].SentDateTime == new DateTime(year, month, day + 1, 12, 0, 2));
            ...
            Assert.True(results[3].EventMessageId == 3 && results[3].SentDateTime == new DateTime(year, month, day + 1, 12, 0, 2));
        }
    }
}